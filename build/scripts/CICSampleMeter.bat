...
@rem ##########################################################################
@rem
@rem  CICSampleMeter startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and CIC_SAMPLE_METER_OPTS to pass JVM options to this script.
...
@rem Execute CICSampleMeter
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CIC_SAMPLE_METER_OPTS%  -classpath "%CLASSPATH%" cic.cs.unb.ca.ifm.App %CMD_LINE_ARGS%
...
:fail
rem Set variable CIC_SAMPLE_METER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%CIC_SAMPLE_METER_EXIT_CONSOLE%" exit 1
exit /b 1
