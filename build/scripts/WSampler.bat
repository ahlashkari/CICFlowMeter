...
@rem ##########################################################################
@rem
@rem  WSampler startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and W_SAMPLER_OPTS to pass JVM options to this script.
...
@rem Execute WSampler
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %W_SAMPLER_OPTS%  -classpath "%CLASSPATH%" cic.cs.unb.ca.ifm.CmdSampling %CMD_LINE_ARGS%
...
:fail
rem Set variable W_SAMPLER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%W_SAMPLER_EXIT_CONSOLE%" exit 1
exit /b 1
